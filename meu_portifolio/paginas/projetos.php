...
<body>
    <div class="container-fluid">
        <div class="row mt-5">
            ...
            <!-- projeto 3 -->
            <div class="col">
                <a href="../projetos/pag_inteligencia_artificial/index.html" target="_blank" class="link-projetos">
                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="../img/pag_IA.PNG" class="img img-ia rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Pagína inteligência Artigicial</h5>
                                    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo,
                                        aliquam assumenda! Aliquam dolorum magnam eveniet! Architecto maiores qui fugiat
                                    </p>
                                    <p class="card-text"><small class="text-body-secondary">Last updated 3 mins ago
                                        </small></p>
                                </div>
